...
fetch("https://sarak-tank-db.onrender.com/pitches")
  .then((res) => res.json())
  .then((data) => {
    makeCard(data);
    filterData = data;
...
function deleteData(id) {
  fetch(`https://sarak-tank-db.onrender.com/pitches/${id}`, {
    method: "DELETE",
  })
    .then((res) => res.json())
    .then((data) => {
...
function updatePitch(id) {
  fetch(`https://sarak-tank-db.onrender.com/pitches/${id}`).then((res) => res.json()).then((data) => {
...
updatePitchBtn.addEventListener('click', () => {
  ...
  fetch(`https://sarak-tank-db.onrender.com/pitches/${updateOBJ.id}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
